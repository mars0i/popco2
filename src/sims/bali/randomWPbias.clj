...
;; Model with worldly-peasant (WP) bias and (1-winner) success bias, but where "success" is randomly chosen.
;; 2 pundits, each with constant maximum quality.
(ns sims.bali.randomWPbias
...
;; args:                        ID    UNMASKED                           PROPN-NET                 ANALOGY-NET UTTERABLE-IDS          GROUPS      TALK-TO-GROUPS             MAX-TALK-TO BIAS-FILTER           QUALITY-FN
      ...
      peasant (pers/make-person :peas spiritual+worldly-peasant-propns   c/no-perc-pnet            c/anet      c/spiritual-propn-ids  [:peasants] [:peasants]                     5      cl/max-quality-filter s/random-quality)] 
