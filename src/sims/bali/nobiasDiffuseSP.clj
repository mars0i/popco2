...
(let [;; an abbreviation for every propn in the SP group:
      ...
      just-one-SP-propns-00 (conj all-but-SP-propns sp0),  just-one-SP-propns-01 (conj all-but-SP-propns sp1),  just-one-SP-propns-02 (conj all-but-SP-propns sp2),
      just-one-SP-propns-03 (conj all-but-SP-propns sp3),  just-one-SP-propns-04 (conj all-but-SP-propns sp4),  just-one-SP-propns-05 (conj all-but-SP-propns sp5),
      just-one-SP-propns-06 (conj all-but-SP-propns sp6),  just-one-SP-propns-07 (conj all-but-SP-propns sp7),  just-one-SP-propns-08 (conj all-but-SP-propns sp8),
      just-one-SP-propns-09 (conj all-but-SP-propns sp9),  just-one-SP-propns-10 (conj all-but-SP-propns sp10), just-one-SP-propns-11 (conj all-but-SP-propns sp11),
      just-one-SP-propns-12 (conj all-but-SP-propns sp12), just-one-SP-propns-13 (conj all-but-SP-propns sp13), just-one-SP-propns-14 (conj all-but-SP-propns sp14),
      just-one-SP-propns-15 (conj all-but-SP-propns sp15), just-one-SP-propns-16 (conj all-but-SP-propns sp16), just-one-SP-propns-17 (conj all-but-SP-propns sp17)
...
;; args:                        ID       UNMASKED              PROPN-NET                           ANALOGY-NET         UTTERABLE-IDS                 GROUPS      TALK-TO-GROUPS MAX-TALK-TO BIAS-FILTER QUALITY-FN
      aat     (pers/make-person :aat     c/spiritual-propns    c/spiritual-brahmanic-perc-pnet     c/anet              c/spiritual-propn-ids         [:pundits]  [:peasants]    1           nil         (constantly 1))
      aaf     (pers/make-person :aaf     c/spiritual-propns    c/spiritual-brahmanic-neg-perc-pnet c/anet              c/spiritual-propn-ids         [:pundits]  [:peasants]    1           nil         (constantly 1))
