...
;; THIS DOESN'T WORK.  ALL ACTIVATIONS REMAINED ZERO FOR ALL TICKS IN ALL RUNS.
;; EVEN THE PUNDITS.
;; WTF?
;; TODO HERE's THE BUG (?):
;; I think the problem is that the pundits have propn nets that peg only
;; spiritual propns, but they unmask only worldly propns.  therefore none
;; of the pegged propns are unmasked.
;; Although that's not what I see, but maybe the mask has already been applied before I see the activns.
