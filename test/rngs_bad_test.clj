...
(println "\nnoop, just iterate:")
(crit/bench (print " " (nth noopi n)))
(println "\nmersenne-twister:")
(crit/bench (print " " (nth mti n)))
(println "\nmersenne-twister-fast:")
(crit/bench (print " " (nth mtfi n)))
(println "\nsfmt19937:")
(crit/bench (print " " (nth sfmti n)))
(println "\nwell:")
(crit/bench (print " " (nth welli n)))
(println "\nclojure rand-int:")
(crit/bench (print " " (nth ri n)))
(println "\ndata.generators long:")
(crit/bench (print " " (nth dgri n)))
